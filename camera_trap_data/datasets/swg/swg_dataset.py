...
class SwgDataset:
    def __init__(self, dataset_config):
        """
        swg-specific dataset class.

        Args:
            dataset_config (dict): Configuration for the swg dataset.
        """
    ...
    def load_metadata(self):
        """
        Load and organize swg-specific metadata based on the configuration.
        ...
        metadata_path = os.path.join(current_dir, "metadata", "swg_metadata.json")
        bbox_path = os.path.join(current_dir, "metadata", "swg_bbox.json")
        ...
        swg_config = self.dataset_config
        ...
        all_camera = swg_config.get("all_camera", False)
        cameras = swg_config.get("cameras", [])
    ...
    def _get_camera_data(self, dataset_name, cameras=None):
        """
        Retrieve data entries for cameras in swg.
