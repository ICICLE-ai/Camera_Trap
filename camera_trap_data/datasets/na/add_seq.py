...
if node_id in rerun:
    ...
    wandb.init(project = "location-processing", config = {"node_id": node_id})
    ...
    for location in node_locations:
        ...
        if all("datetime" in image for image in filtered_images):
    ...
    output_path = f"/fs/ess/PAS2099/Vidhi/camera_trap_data/datasets/na/metadata/na_metadata_with_seq_{node_id}.json"
