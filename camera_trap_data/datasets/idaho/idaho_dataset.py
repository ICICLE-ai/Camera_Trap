...
class IdahoDataset:
    ...
    def load_metadata(self):
        ...
        metadata_path = os.path.join(current_dir, "metadata", "idaho_metadata.json")
        bbox_path = os.path.join(current_dir, "metadata", "idaho_bbox.json")
        ...
        idaho_config = self.dataset_config
        organized_metadata = {}
        dataset_name = "idaho"

        all_camera = idaho_config.get("all_camera", False)
        cameras = idaho_config.get("cameras", [])
    ...
    def _format_location(self, location):
        ...
        Returns:
            str: Formatted location string (e.g., "idaho_CA-30").
        """
